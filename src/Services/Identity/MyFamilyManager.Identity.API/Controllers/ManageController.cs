...
using MyFamilyManager.Identity.API.Models.ManageViewModels;
...
namespace MyFamilyManager.Identity.API.Controllers
{
    [Authorize]
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            StatusMessage = "Profile has been reset";
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            await _emailSender.SendEmail(
               model.Email,
               "MyFamilyManager.Identity.API Verification Email",
               $"Please verify by clicking here: {callbackUrl}",
               "Hi Sir");

            StatusMessage = "Status Update profile email sent";
            return RedirectToAction(nameof(Index));
        }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MyFamilyManager.Identity.API"),
